  ...
  interfaces_port_channels = flatten([
    for device in local.devices : [
      for int in try(local.device_config[device.name].interfaces.port_channels, []) : {
        ...
        ospf_passive                            = try(int.ospf.passive_interface, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospf.passive_interface, null)
        ...
        isis_bfd                                = try(int.isis.bfd, local.defaults.nxos.devices.configuration.interfaces.port_channels.isis.bfd, null)
