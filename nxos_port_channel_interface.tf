  ...
  interfaces_port_channels = flatten([
    for device in local.devices : [
      for int in try(local.device_config[device.name].interfaces.port_channels, []) : {
        ...
        ospf_bfd                                = try(int.ospf.bfd, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospf.bfd, null) == null ? null : (try(int.ospf.bfd, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospf.bfd) ? "enabled" : "disabled")
        ...
        ospf_network_type                       = try(int.ospf.network, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospf.network, null)
        ospf_passive                            = try(int.ospf.passive_interface, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospf.passive_interface, null) == null ? null : (try(int.ospf.passive_interface, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospf.passive_interface) ? "enabled" : "disabled")
        ...
        ospf_authentication_key_id              = try(int.ospf.message_digest_key_id, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospf.message_digest_key_id, null)
        ...
        ospf_authentication_md5_key             = try(int.ospf.message_digest_key, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospf.message_digest_key, null)
        ospf_authentication_md5_key_secure_mode = try(int.ospf.message_digest_key_secure_mode, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospf.message_digest_key_secure_mode, false)
        ospf_authentication_type                = try(int.ospf.authentication, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospf.authentication, null)
        ...
        ospf_node_flag                          = try(int.ospf.prefix_attribute_n_flag, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospf.prefix_attribute_n_flag, null)
        ...
        ospfv3_bfd                              = try(int.ospfv3.bfd, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospfv3.bfd, null) == null ? null : (try(int.ospfv3.bfd, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospfv3.bfd) ? "enabled" : "disabled")
        ...
        ospfv3_passive_interface                = try(int.ospfv3.passive_interface, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospfv3.passive_interface, null) == null ? null : (try(int.ospfv3.passive_interface, local.defaults.nxos.devices.configuration.interfaces.port_channels.ospfv3.passive_interface) ? "enabled" : "disabled")
        ...
        isis_network_point_to_point             = try(int.isis.network_point_to_point, local.defaults.nxos.devices.configuration.interfaces.port_channels.isis.network_point_to_point, null)
        isis_passive_interface                  = try(int.isis.passive_interface, local.defaults.nxos.devices.configuration.interfaces.port_channels.isis.passive_interface, null)
        ...
        isis_bfd                                = try(int.isis.bfd, local.defaults.nxos.devices.configuration.interfaces.port_channels.isis.bfd, null) == null ? null : (try(int.isis.bfd, local.defaults.nxos.devices.configuration.interfaces.port_channels.isis.bfd) ? "enabled" : "disabled")
        isis_ipv6_bfd                           = try(int.isis.ipv6_bfd, local.defaults.nxos.devices.configuration.interfaces.port_channels.isis.ipv6_bfd, null) == null ? null : (try(int.isis.ipv6_bfd, local.defaults.nxos.devices.configuration.interfaces.port_channels.isis.ipv6_bfd) ? "enabled" : "disabled")
        ...
        isis_lsp_interval                       = try(int.isis.lsp_interval, local.defaults.nxos.devices.configuration.interfaces.port_channels.isis.lsp_interval, null)
        ...
        isis_mesh_group                         = try(int.isis.mesh_group, local.defaults.nxos.devices.configuration.interfaces.port_channels.isis.mesh_group, null)
        ...
        isis_suppress_prefix                    = try(int.isis.suppress_prefix, local.defaults.nxos.devices.configuration.interfaces.port_channels.isis.suppress_prefix, null)
      }
    ]
  ])
}
...
resource "nxos_port_channel_interface" "port_channel_interface" {
  ...
  port_channel_interfaces = { for int in try(local.device_config[each.key].interfaces.port_channels, []) : "po${int.id}" => {
    ...
    access_vlan           = !try(int.switchport.enabled, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.enabled, true) ? "unknown" : "vlan-${try(int.switchport.access_vlan, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.access_vlan, 1)}"
    ...
    layer                 = !try(int.switchport.enabled, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.enabled, true) ? "Layer3" : "Layer2"
    ...
    mode                  = try(local.switchport_mode_map[try(int.switchport.mode, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.mode)], try(int.switchport.mode, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.mode, null))
    mtu                   = try(int.mtu, local.defaults.nxos.devices.configuration.interfaces.port_channels.mtu, null)
    native_vlan           = !try(int.switchport.enabled, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.enabled, true) ? "unknown" : "vlan-${try(int.switchport.trunk_native_vlan, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.trunk_native_vlan, 1)}"
    speed                 = try(int.speed, local.defaults.nxos.devices.configuration.interfaces.port_channels.speed, null)
    trunk_vlans           = !try(int.switchport.enabled, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.enabled, true) ? "1-4094" : try(int.switchport.trunk_allowed_vlans, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.trunk_allowed_vlans, null)
    ...
    transmission_mode     = try(int.switchport.transparent_mode, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.transparent_mode, null) == null ? null : (try(int.switchport.transparent_mode, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.transparent_mode) ? "trans-port" : "not-a-trans-port")
    ...
    vrf_dn                = !try(int.switchport.enabled, local.defaults.nxos.devices.configuration.interfaces.port_channels.switchport.enabled, true) ? "sys/inst-${try(int.vrf, local.defaults.nxos.devices.configuration.interfaces.port_channels.vrf, "default")}" : null
