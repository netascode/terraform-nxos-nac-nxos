  ...
  interfaces_port_channels = flatten([
    for device in local.devices : [
      for int in try(local.device_config[device.name].interfaces.port_channels, []) : {
        ...
        id                       = int.id
        type                     = "po"
        port_channel_mode        = try(int.port_channel_mode, local.defaults.nxos.devices.configuration.interfaces.port_channels.port_channel_mode, "on")
        minimum_links            = try(int.minimum_links, local.defaults.nxos.devices.configuration.interfaces.port_channels.minimum_links, 1)
        maximum_links            = try(int.maximum_links, local.defaults.nxos.devices.configuration.interfaces.port_channels.maximum_links, 32)
        suspend_individual       = try(int.suspend_individual, local.defaults.nxos.devices.configuration.interfaces.port_channels.suspend_individual, "enable")
        access_vlan              = try(int.access_vlan, local.defaults.nxos.devices.configuration.interfaces.port_channels.access_vlan, 1)
        admin_state              = try(int.admin_state, local.defaults.nxos.devices.configuration.interfaces.port_channels.admin_state, false)
        ...
        layer3                   = try(int.layer3, local.defaults.nxos.devices.configuration.interfaces.port_channels.layer3, false)
        link_logging             = try(int.link_logging, local.defaults.nxos.devices.configuration.interfaces.port_channels.link_logging, null)
        ...
        native_vlan              = try(int.native_vlan, local.defaults.nxos.devices.configuration.interfaces.port_channels.native_vlan, 1)
        speed                    = try(int.speed, local.defaults.nxos.devices.configuration.interfaces.port_channels.speed, null)
        trunk_vlans              = try(int.trunk_vlans, local.defaults.nxos.devices.configuration.interfaces.port_channels.trunk_vlans, null)
        vrf                      = try(int.vrf, local.defaults.nxos.devices.configuration.interfaces.port_channels.vrf, "default")
        ip_unnumbered            = try(int.ip_unnumbered, local.defaults.nxos.devices.configuration.interfaces.port_channels.ip_unnumbered, null)
        ...
        ipv4_secondary_addresses = try(int.ipv4_secondary_addresses, local.defaults.nxos.devices.configuration.interfaces.port_channels.ipv4_secondary_addresses, [])
      }
    ]
  ])
