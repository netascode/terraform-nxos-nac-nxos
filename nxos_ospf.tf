...
locals {
  ospf_interfaces = concat(local.interfaces_ethernets, local.interfaces_subinterfaces, local.interfaces_loopbacks, local.interfaces_vlans, local.interfaces_port_channels)
}
