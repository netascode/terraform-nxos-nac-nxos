...
resource "nxos_dhcp" "dhcp" {
  ...
  relay_information_option_trust              = try(local.device_config[each.key].dhcp.ip_dhcp_relay.information_option_trust, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_relay.information_option_trust, null)
  relay_information_option_vpn                = try(local.device_config[each.key].dhcp.ip_dhcp_relay.information_option_vpn, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_relay.information_option_vpn, null)
  relay_information_trust_all                 = try(local.device_config[each.key].dhcp.ip_dhcp_relay.information_trust_all, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_relay.information_trust_all, null)
  relay_information_option_server_id_override = try(local.device_config[each.key].dhcp.ip_dhcp_relay.information_option_server_id_override, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_relay.information_option_server_id_override, null) == null ? null : (try(local.device_config[each.key].dhcp.ip_dhcp_relay.information_option_server_id_override, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_relay.information_option_server_id_override) ? 1 : 0)
  relay_sub_option_circuit_id_customized      = try(local.device_config[each.key].dhcp.ip_dhcp_relay.sub_option_circuit_id_customized, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_relay.sub_option_circuit_id_customized, null)
  relay_sub_option_circuit_id_format_string   = try(local.device_config[each.key].dhcp.ip_dhcp_relay.sub_option_circuit_id_format_string, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_relay.sub_option_circuit_id_format_string, null)
  relay_sub_option_type_cisco                 = try(local.device_config[each.key].dhcp.ip_dhcp_relay.sub_option_type_cisco, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_relay.sub_option_type_cisco, null)
  relay_sub_option_format_non_tlv             = try(local.device_config[each.key].dhcp.ip_dhcp_relay.sub_option_format_non_tlv, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_relay.sub_option_format_non_tlv, null)
  smart_relay_global                          = try(local.device_config[each.key].dhcp.ip_dhcp_smart_relay_global, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_smart_relay_global, null)
  v4_relay                                    = try(local.device_config[each.key].dhcp.ip_dhcp_relay.enabled, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_relay.enabled, null)
  ...
  v6_smart_relay_global                       = try(local.device_config[each.key].dhcp.ipv6_dhcp_relay.smart_relay_global, local.defaults.nxos.devices.configuration.dhcp.ipv6_dhcp_relay.smart_relay_global, null)
  packet_strict_validation                    = try(local.device_config[each.key].dhcp.ip_dhcp_packet_strict_validation, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_packet_strict_validation, null)
  snooping                                    = try(local.device_config[each.key].dhcp.ip_dhcp_snooping.enabled, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_snooping.enabled, null)
  snooping_information_option                 = try(local.device_config[each.key].dhcp.ip_dhcp_snooping.information_option, local.defaults.nxos.devices.configuration.dhcp.ip_dhcp_snooping.information_option, null)
  ...
  relay_interfaces = { for item in local.dhcp_relay_interfaces : item.interface_id => {
    information_trusted = try(item.ip_dhcp_relay_information_trusted, local.defaults.nxos.devices.configuration.interfaces.ethernets.ip.dhcp_relay_information_trusted, null)
    smart_relay         = try(item.ip_dhcp_relay_smart_relay, local.defaults.nxos.devices.configuration.interfaces.ethernets.ip.dhcp_relay_smart_relay, null)
    subnet_broadcast    = try(item.ip_dhcp_relay_subnet_broadcast, local.defaults.nxos.devices.configuration.interfaces.ethernets.ip.dhcp_relay_subnet_broadcast, null)
    options             = try(item.ip_dhcp_relay_information_option, local.defaults.nxos.devices.configuration.interfaces.ethernets.ip.dhcp_relay_information_option, null) == null ? null : (try(item.ip_dhcp_relay_information_option, local.defaults.nxos.devices.configuration.interfaces.ethernets.ip.dhcp_relay_information_option) ? "relay-info" : "none")
    subnet_selection    = try(item.ip_dhcp_relay_source_subnet, local.defaults.nxos.devices.configuration.interfaces.ethernets.ip.dhcp_relay_source_subnet, null)
    v6_smart_relay      = try(item.ipv6_dhcp_smart_relay, local.defaults.nxos.devices.configuration.interfaces.ethernets.ipv6.dhcp_smart_relay, null)
    addresses = merge(
