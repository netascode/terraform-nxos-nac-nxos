...
resource "nxos_dhcp" "dhcp" {
  ...
  relay_interfaces = { for item in local.dhcp_relay_interfaces : item.interface_id => {
    ...
    options             = try(item.ip_dhcp_relay.information_option, local.defaults.nxos.devices.configuration.interfaces.ethernets.ip_dhcp_relay.information_option, null) == null ? null : (try(item.ip_dhcp_relay.information_option, local.defaults.nxos.devices.configuration.interfaces.ethernets.ip_dhcp_relay.information_option) ? "relay-info" : "none")
