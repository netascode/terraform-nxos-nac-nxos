  ...
  interfaces_vlans = flatten([
    for device in local.devices : [
      for int in try(local.device_config[device.name].interfaces.vlans, []) : {
        ...
        ip_forward                              = try(int.ip.forward, local.defaults.nxos.devices.configuration.interfaces.vlans.ip.forward, false)
        ip_drop_glean                           = try(int.ip.drop_glean, local.defaults.nxos.devices.configuration.interfaces.vlans.ip.drop_glean, false)
        ...
        ospf_bfd                                = try(int.ospf.bfd, local.defaults.nxos.devices.configuration.interfaces.vlans.ospf.bfd, null) == null ? null : (try(int.ospf.bfd, local.defaults.nxos.devices.configuration.interfaces.vlans.ospf.bfd) ? "enabled" : "disabled")
        ...
        ospf_passive                            = try(int.ospf.passive_interface, local.defaults.nxos.devices.configuration.interfaces.vlans.ospf.passive_interface, null) == null ? null : (try(int.ospf.passive_interface, local.defaults.nxos.devices.configuration.interfaces.vlans.ospf.passive_interface) ? "enabled" : "disabled")
        ...
        ospfv3_bfd                              = try(int.ospfv3.bfd, local.defaults.nxos.devices.configuration.interfaces.vlans.ospfv3.bfd, null) == null ? null : (try(int.ospfv3.bfd, local.defaults.nxos.devices.configuration.interfaces.vlans.ospfv3.bfd) ? "enabled" : "disabled")
        ...
        ospfv3_passive_interface                = try(int.ospfv3.passive_interface, local.defaults.nxos.devices.configuration.interfaces.vlans.ospfv3.passive_interface, null) == null ? null : (try(int.ospfv3.passive_interface, local.defaults.nxos.devices.configuration.interfaces.vlans.ospfv3.passive_interface) ? "enabled" : "disabled")
        ...
        isis_bfd                                = try(int.isis.bfd, local.defaults.nxos.devices.configuration.interfaces.vlans.isis.bfd, null) == null ? null : (try(int.isis.bfd, local.defaults.nxos.devices.configuration.interfaces.vlans.isis.bfd) ? "enabled" : "disabled")
        isis_ipv6_bfd                           = try(int.isis.ipv6_bfd, local.defaults.nxos.devices.configuration.interfaces.vlans.isis.ipv6_bfd, null) == null ? null : (try(int.isis.ipv6_bfd, local.defaults.nxos.devices.configuration.interfaces.vlans.isis.ipv6_bfd) ? "enabled" : "disabled")
