...
resource "nxos_system" "system" {
  ...
  platform_extended_acl_disable_redirect_share          = try(local.device_config[each.key].system.platform.acl_redirect_share_disable, null) == null ? null : (try(local.device_config[each.key].system.platform.acl_redirect_share_disable) ? "enable" : "disable")
  platform_extended_atomic_update                       = try(local.device_config[each.key].system.platform.tcam_atomic_update, null) == null ? null : (try(local.device_config[each.key].system.platform.tcam_atomic_update) ? "enable" : "disable")
  platform_extended_atomic_update_strict                = try(local.device_config[each.key].system.platform.tcam_atomic_update_strict, null) == null ? null : (try(local.device_config[each.key].system.platform.tcam_atomic_update_strict) ? "enable" : "disable")
  platform_extended_counter_manager_bfd_scale           = try(local.device_config[each.key].system.platform.counter_bfd_feature_scale, null)
  platform_extended_counter_manager_ecn_scale           = try(local.device_config[each.key].system.platform.counter_ecn_feature_scale, null)
  platform_extended_counter_manager_egress_acl_scale    = try(local.device_config[each.key].system.platform.counter_egress_acl_feature_scale, null)
  platform_extended_counter_manager_feature_bfd         = try(local.device_config[each.key].system.platform.counter_bfd_feature, null)
  platform_extended_counter_manager_feature_ecn         = try(local.device_config[each.key].system.platform.counter_ecn_feature, null)
  platform_extended_counter_manager_feature_egress_acl  = try(local.device_config[each.key].system.platform.counter_egress_acl_feature, null)
  platform_extended_counter_manager_feature_ingress_acl = try(local.device_config[each.key].system.platform.counter_ingress_acl_feature, null)
  platform_extended_counter_manager_feature_l2vni       = try(local.device_config[each.key].system.platform.counter_l2vni_feature, null)
  platform_extended_counter_manager_feature_l3vni       = try(local.device_config[each.key].system.platform.counter_l3vni_feature, null)
  platform_extended_counter_manager_feature_si          = try(local.device_config[each.key].system.platform.counter_si_feature, null)
  platform_extended_counter_manager_feature_svi         = try(local.device_config[each.key].system.platform.counter_svi_feature, null)
  platform_extended_counter_manager_feature_tunnel      = try(local.device_config[each.key].system.platform.counter_tunnel_feature, null)
  platform_extended_counter_manager_feature_vlan        = try(local.device_config[each.key].system.platform.counter_vlan_feature, null)
  platform_extended_counter_manager_feature_voq         = try(local.device_config[each.key].system.platform.counter_voq_feature, null)
  platform_extended_counter_manager_ingress_acl_scale   = try(local.device_config[each.key].system.platform.counter_ingress_acl_feature_scale, null)
  platform_extended_counter_manager_l2vni_scale         = try(local.device_config[each.key].system.platform.counter_l2vni_feature_scale, null)
  platform_extended_counter_manager_l3vni_scale         = try(local.device_config[each.key].system.platform.counter_l3vni_feature_scale, null)
  platform_extended_counter_manager_si_scale            = try(local.device_config[each.key].system.platform.counter_si_feature_scale, null)
  platform_extended_counter_manager_svi_scale           = try(local.device_config[each.key].system.platform.counter_svi_feature_scale, null)
  platform_extended_counter_manager_tunnel_scale        = try(local.device_config[each.key].system.platform.counter_tunnel_feature_scale, null)
  platform_extended_counter_manager_vlan_scale          = try(local.device_config[each.key].system.platform.counter_vlan_feature_scale, null)
  platform_extended_counter_manager_voq_scale           = try(local.device_config[each.key].system.platform.counter_voq_feature_scale, null)
  platform_extended_dme_load_interval                   = try(local.device_config[each.key].system.platform.dme_load_interval, null)
  platform_extended_egress_l2_qos_ifacl_label_size      = try(local.device_config[each.key].system.platform.egress_l2_qos_ifacl_label_size, null) == null ? null : (try(local.device_config[each.key].system.platform.egress_l2_qos_ifacl_label_size) ? "enable" : "disable")
  platform_extended_gpe5_timer_enable                   = try(local.device_config[each.key].system.platform.gpe5_timer, null)
  platform_extended_hardware_qos_latency_optimized      = try(local.device_config[each.key].system.platform.qos_latency_optimized, null)
  platform_extended_ingress_pacl_ifacl_label_size       = try(local.device_config[each.key].system.platform.ingress_pacl_ifacl_label_size, null) == null ? null : (try(local.device_config[each.key].system.platform.ingress_pacl_ifacl_label_size) ? "enable" : "disable")
  platform_extended_ingress_vrf_nat_bd_label_width      = try(local.device_config[each.key].system.platform.ingress_vrf_nat_bd_label_width, null)
  platform_extended_mpls_qos_pipe_mode                  = try(local.device_config[each.key].system.platform.mpls_qos_pipe_mode, null) == null ? null : (try(local.device_config[each.key].system.platform.mpls_qos_pipe_mode) ? "enabled" : "disabled")
  platform_extended_multicast_nlb_stick_port_channel    = try(local.device_config[each.key].system.platform.multicast_nlb_stick_port_channel, null) == null ? null : (try(local.device_config[each.key].system.platform.multicast_nlb_stick_port_channel) ? "enable" : "disable")
  platform_extended_multicast_priority                  = try(local.device_config[each.key].system.platform.multicast_priority, null)
  platform_extended_multicast_stats_disable             = try(local.device_config[each.key].system.platform.multicast_stats_disable, null) == null ? null : (try(local.device_config[each.key].system.platform.multicast_stats_disable) ? "enable" : "disable")
  platform_extended_pbr_ecmp_paths                      = try(local.device_config[each.key].system.platform.pbr_ecmp_paths, null)
  platform_extended_pbr_fast_convergence                = try(local.device_config[each.key].system.platform.pbr_fast_convergence, null) == null ? null : (try(local.device_config[each.key].system.platform.pbr_fast_convergence) ? "enable" : "disable")
  platform_extended_pbr_match_default_route             = try(local.device_config[each.key].system.platform.pbr_match_default_route, null) == null ? null : (try(local.device_config[each.key].system.platform.pbr_match_default_route) ? "enable" : "disable")
  platform_extended_ptp_correction_hardware             = try(local.device_config[each.key].system.platform.ptp_correction_hardware, null)
  platform_extended_si_flex_stats                       = try(local.device_config[each.key].system.platform.sub_interface_flex_stats, null)
  platform_extended_stats_template                      = try(local.device_config[each.key].system.platform.stats_template, null)
  platform_extended_storm_control_priority              = try(local.device_config[each.key].system.platform.storm_control_priority, null)
  platform_extended_tcam_default_result                 = try(local.device_config[each.key].system.platform.tcam_default_result, null) == null ? null : (try(local.device_config[each.key].system.platform.tcam_default_result) ? "enable" : "disable")
  platform_extended_udf_netflow_rtp_multicast_enabled   = try(local.device_config[each.key].system.platform.udf_netflow_rtp_multicast, null)
  platform_extended_vrf_aware_nat_enable                = try(local.device_config[each.key].system.platform.vrf_aware_nat, null) == null ? null : (try(local.device_config[each.key].system.platform.vrf_aware_nat) ? "enabled" : "disabled")
