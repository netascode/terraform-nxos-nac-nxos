...
resource "nxos_system" "system" {
  for_each = { for device in local.devices : device.name => device
    ...
    try(local.device_config[device.name].ipv6.nd, null) != null ||
  ...
  nd_accept_solicit_neighbor_entry       = try(local.device_config[each.key].ipv6.nd.accept_solicit_neighbor_entry, local.defaults.nxos.devices.configuration.ipv6.nd.accept_solicit_neighbor_entry, null)
  ...
  nd_solicit_neighbor_advertisement      = try(local.device_config[each.key].ipv6.nd.solicit_neighbor_advertisement, local.defaults.nxos.devices.configuration.ipv6.nd.solicit_neighbor_advertisement, null) != null ? (try(local.device_config[each.key].ipv6.nd.solicit_neighbor_advertisement, local.defaults.nxos.devices.configuration.ipv6.nd.solicit_neighbor_advertisement) ? "enabled" : "disabled") : null
