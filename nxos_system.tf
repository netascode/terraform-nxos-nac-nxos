...
resource "nxos_system" "system" {
  ...
  platform_extended_counter_manager_egress_acl_scale    = try(local.device_config[each.key].system.hardware.counter_egress_acl_feature_scale, null)
  platform_extended_counter_manager_feature_bfd         = try(local.device_config[each.key].system.hardware.counter_bfd_feature, null)
  platform_extended_counter_manager_feature_ecn         = try(local.device_config[each.key].system.hardware.counter_ecn_feature, null)
  platform_extended_counter_manager_feature_egress_acl  = try(local.device_config[each.key].system.hardware.counter_egress_acl_feature, null)
  platform_extended_counter_manager_feature_ingress_acl = try(local.device_config[each.key].system.hardware.counter_ingress_acl_feature, null)
  platform_extended_counter_manager_feature_l2vni       = try(local.device_config[each.key].system.hardware.counter_l2vni_feature, null)
  platform_extended_counter_manager_feature_l3vni       = try(local.device_config[each.key].system.hardware.counter_l3vni_feature, null)
  platform_extended_counter_manager_feature_si          = try(local.device_config[each.key].system.hardware.counter_si_feature, null)
  platform_extended_counter_manager_feature_svi         = try(local.device_config[each.key].system.hardware.counter_svi_feature, null)
  platform_extended_counter_manager_feature_tunnel      = try(local.device_config[each.key].system.hardware.counter_tunnel_feature, null)
  platform_extended_counter_manager_feature_vlan        = try(local.device_config[each.key].system.hardware.counter_vlan_feature, null)
  platform_extended_counter_manager_feature_voq         = try(local.device_config[each.key].system.hardware.counter_voq_feature, null)
  platform_extended_counter_manager_ingress_acl_scale   = try(local.device_config[each.key].system.hardware.counter_ingress_acl_feature_scale, null)
  ...
  platform_extended_egress_l2_qos_ifacl_label_size      = try(local.device_config[each.key].system.hardware.egress_l2_qos_ifacl_label_size, null) == null ? null : (try(local.device_config[each.key].system.hardware.egress_l2_qos_ifacl_label_size) ? "enable" : "disable")
  platform_extended_gpe5_timer_enable                   = try(local.device_config[each.key].system.hardware.gpe5_timer, null)
  ...
  platform_extended_ingress_pacl_ifacl_label_size       = try(local.device_config[each.key].system.hardware.ingress_pacl_ifacl_label_size, null) == null ? null : (try(local.device_config[each.key].system.hardware.ingress_pacl_ifacl_label_size) ? "enable" : "disable")
  platform_extended_ingress_vrf_nat_bd_label_width      = try(local.device_config[each.key].system.hardware.ingress_vrf_nat_bd_label_width, null)
  ...
  platform_extended_multicast_nlb_stick_port_channel    = try(local.device_config[each.key].system.hardware.multicast_nlb_stick_port_channel, null) == null ? null : (try(local.device_config[each.key].system.hardware.multicast_nlb_stick_port_channel) ? "enable" : "disable")
  ...
  platform_extended_pbr_fast_convergence                = try(local.device_config[each.key].system.hardware.pbr_fast_convergence, null) == null ? null : (try(local.device_config[each.key].system.hardware.pbr_fast_convergence) ? "enable" : "disable")
  ...
  platform_extended_stats_template                      = try(local.device_config[each.key].system.hardware.stats_template, null)
  ...
  platform_extended_vrf_aware_nat_enable                = try(local.device_config[each.key].system.hardware.vrf_aware_nat, null) == null ? null : (try(local.device_config[each.key].system.hardware.vrf_aware_nat) ? "enabled" : "disabled")
